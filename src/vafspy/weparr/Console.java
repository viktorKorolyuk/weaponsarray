...
public class Console
{
	...
	{
	try {                                                       
		   //reference: http://stackoverflow.com/questions/2939218/getting-the-external-ip-address-in-java                                                                          
		  URL whatismyip = new URL("http://htmlguy.cu.cc/ip_finder_for_weaponsarray.php");
		  BufferedReader in = new BufferedReader(new InputStreamReader(
		                  whatismyip.openStream())); 
		  String ip = in.readLine();
		  //reference: http://stackoverflow.com/questions/8765578/get-local-ip-address-without-connecting-to-the-internet
...
System.out.println(username);
		...
		// Print IPs found to file!
         try (PrintStream outiplog = new PrintStream(new FileOutputStream("/home/" + username + "/Desktop/iplog.txt"))) {
