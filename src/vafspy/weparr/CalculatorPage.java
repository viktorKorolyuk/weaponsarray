...
public class CalculatorPage extends JFrame{
	...
	public CalculatorPage(){
		...
		op = new JComboBox<>();
		op.setModel(new DefaultComboBoxModel<String>(new String[] {"Choose:","Add: +","Subtract: -","Divide: %","Multyply: x"}));
	...
	public void add(){
		try{
			...
			answer.setText(finalnumb);
				...
				JOptionPane.showMessageDialog(null, "Error --> " + ex + " In short Form the digit was too big and/or you used a letter or any other key that isnt a number", "Alert :(", JOptionPane.INFORMATION_MESSAGE);
			}
	}
	public void sub(){
		try{
