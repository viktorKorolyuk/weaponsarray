...
public virus() {
	...
	yes.addActionListener(new ActionListener() {
		...
		{
			JOptionPane.showMessageDialog(null, "Finaly Youre Truthfull!", "Alert", JOptionPane.INFORMATION_MESSAGE);
			JOptionPane.showMessageDialog(null, "Too bad youre still getting the virus", "Alert", JOptionPane.INFORMATION_MESSAGE);
			still();
		}});
	frame.add(yes);
...
public void noNo(){
	...
	/* Why are these here? They are just taking up space and adding compile warnings. commenting out!
